...
def load_environ():
    ...
    if 'HBNB_TYPE_STORAGE' not in os.environ and not os.getenv("HBNB_TYPE_STORAGE") == 'db':
        ...
        if os.getenv('HBNB_TYPE_STORAGE') == 'db':
            if not env_vars_set_properly():
                raise TypeError("Environment variables not set correctly required vars include [HBNB_MYSQL_USER, HBNB_MYSQL_PWD, HBNB_MYSQL_HOST, HBNB_MYSQL_DB, HBNB_TYPE_STORAGE]")
